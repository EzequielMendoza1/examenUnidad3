...
?>
    ...
    <script>
        ...
        switch (mensaje) {
            case 'insertar':
                swal('Producto Agregado','Se agrego satisfactoriamente','success');
                break;
            case 'actualizar':
                swal('Producto Actualizado','Se actualizo satisfactoriamente','warning');
                break;
            case 'eliminar':
                swal('Producto eliminado','Se elimino satisfactoriamente','error');
        }
    </script>
